...
VALUES 
    ...
    ('task-seed-3', 'blueampcnergy@gmail.com', 'BOM Printing & Serial Signature Audit', 'Verify digital signatures and printed serial numbers for outgoing dealer orders.', false, '2026-07-27', (EXTRACT(EPOCH FROM NOW()) * 1000)::BIGINT, 'admin'),
